...
const EditUserDetails = ({ onClose, user }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const URL = `https://chat-app-server-qv0f.onrender.com/api/update-user`;
          ...
          <div>
            ...
            <div className="my-1 flex items-center gap-4">
              ...
              <label htmlFor="profile_pic">
                <button
                  className="font-semibold border-primary bg-primary text-white border px-4 py-1 rounded hover:bg-secondary"
